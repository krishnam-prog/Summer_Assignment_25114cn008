...
int main()
{
    int empId[10], basicSalary[10], bonus[10], totalSalary[10];
    char empName[10][20];
        ...
        else if(choice == 2)
        {
            ...
            else
            {
                for(int i=0;i<count;i++)
                {
                    ...
                    cout<<"\nBasic Salary: "<<basicSalary[i];
                    cout<<"\nBonus: "<<bonus[i];
                    cout<<"\nTotal Salary: "<<totalSalary[i]<<endl;
                }
            }
        }
